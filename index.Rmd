...
<div class="header-block">
  ...
  <div class="title">Paul Efren<br>
  <p style="font-size : 1rem; font-family: Playfair Display, serif; color: #454542"> CV - 2024 </p></div>
...
Código disponible en: [github.com/PaulESantos/cv](https://github.com/PaulESantos/cv_spa/).
...
Otras experiencias {data-icon=book}
--------------------------------------------------------------------------------

```{r}
print_section(position_data, 'other_expe')
```
